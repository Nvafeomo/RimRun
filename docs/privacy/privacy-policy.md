...
We do **not** use Google Analytics or similar third-party advertising or analytics SDKs in the App as described in this policy.

### Information from third parties

- **Authentication (Google):** If you sign in with Google, Google processes your login according to Google’s policies. We receive information from that sign-in flow as needed to create and maintain your account (for example, basic profile details tied to your Google account). For how Google handles personal data, see Google’s documentation:
